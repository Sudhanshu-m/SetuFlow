        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-muted mb-4 max-w-sm">
              We build intelligent automation systems for forward-thinking businesses. Save time, reduce costs, and scale faster.
            </p>
            <div className="flex flex-col gap-2 mb-6 text-sm text-muted font-medium">
              <a href="mailto:sudhanshu1439@gmail.com" className="hover:text-primary transition-colors">sudhanshu1439@gmail.com</a>
              <a href="tel:+919372745434" className="hover:text-primary transition-colors">+91 93727 45434</a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted">
              ...
              <li><a href="#" className="hover:text-white transition-colors">WhatsApp Bots</a></li>
              <li><a href="#" className="hover:text-white transition-colors">CRM Integration</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Lead Routing</a></li>
            </ul>
          </div>
